...
public interface ReportGenerator {
     ...
     *
     * The method generates the report using the default template and writes it
     * to a file with a generated unique name.
     *
     ...
     *
     * The method generates the report using the template and writes it to a
     * file with a generated unique name.
     *
     * @param analysis the analysis that should be rendered
    ...
    /**
     * Generate a report from the analysis using a specific template and
     * destination file.
     *
     * @param analysis
     * @param template
