...
public interface GenericDAO<T> {
     ...
     * @throws DAOException when trying to create an object twice or general
     * problem in the underlying persistence mechanism
     */
     ...
     * @throws DAOException on general problems in the underlying persistence
     * mechanism
     */
     ...
     * @throws NoSuchEntityException if the entity we werer trying to delete
     * does not exist
     * @throws DAOException on general problems in the underlying persistence
     * mechanism
     */
     ...
     *
     * This is useful in occasions where an entity has been instantiated and not
     * yet saved but a record with the same attributes already exists in the
     * datastore preventing you from creating another one.
     *
