...
public class BasicBlock implements BasicBlockInterface {
     ...
     *
     * @param nr - the line number to try
    ...
    /**
     *
     * @param b - indicate if this BB is a switch table or not
     */
    ...
    /**
     *
     * @param target - the target CodeLine to search for
    ...
    /**
     * Checks whether the BB contains dead code. This most likely results when
     * someone patches a program in order to return something and skip real
     * code. BBs are build after jmp/goto label/targets and this should not
     * occur in "normal" apps.
     *
     * @return true if the BB contains a return opcode which is not the last
     * opcode.
     */
    ...
    /**
     * Returns the last codeline which contains a real opcode (not comment, dot
     * prefix etc) from the BB.
     *
