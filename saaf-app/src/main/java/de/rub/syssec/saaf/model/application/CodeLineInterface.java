...
public interface CodeLineInterface {
    ...
    /**
     * Denotes whether a codeline contains a "real operation". That means it
     * does not begin with a '.', '#', ':' or is empty at all. If the
     * instruction is not yet parsed and does not not start w/ any sign above,
    ...
    /**
     * A reference to the method where this cl comes from. Null if not set b/c
     * cl does not belong to a method.
     *
    ...
    /**
     * Set the method where this cl comes from. Should be set when the
     * SmaliClass is parsed.
     *
     * @param method
     */
