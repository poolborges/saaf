...
public interface ClassInterface extends Entity, Obfuscatable {
     ...
     *
     * This method was specifically introduced for sitautions where you do not
     * need or want the absolute path (e.g. reports)
     *
     * @return
     */
    ...
    /**
     * Get all CodeLines which have a given opcode. TODO: Diese Methode auch
     * anderen Stellen verwenden und Code Duplication zu vermeiden.
     *
     ...
     * @return a list containing all found CodeLines matching the pattern, the
     * list might be empty
     */
     ...
     *
     * @return A collection with the full class names, may be empty and the
     * interfaces are divided by dots (if any)
     */
    ...
    /**
     * TODO Stub only Checks whether this file is located inside an ad
     * framework's package path
     *
