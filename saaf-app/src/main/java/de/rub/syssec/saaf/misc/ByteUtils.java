...
public class ByteUtils {
    ...
    /**
     * Does this byte array begin with match array content? The check is NOT
     * case sensitive!
     *
     * @param source Byte array to examine
    ...
    /**
     * Does this byte array end with match array content? The check is NOT case
     * sensitive!
     */
    ...
    /**
     * Read a line from an inputstream into a byte buffer. A line might end with
     * a LF or an CRLF. CR's are accepted inside a line and are not understood
     * as a beginning new line. This should work therefore on Mac OS X, Unix,
     * Linux and Windows.
     *
     * See http://en.wikipedia.org/wiki/Newline for more.
     *
     * @param in the inputstream
     * @param maxSize the maximum amount of bytes to read until a CRLF or LF is
     * reached, a value of zero or smaller disables a limit (use w/ care!)
     * @return the buffer where read bytes are appended, this buffer will not
     * contain any CR's or or CRLF's at the end of the array. Null is returned
     * if EOF is reached.
     * @throws IOException if something is wrong w/ the stream or the maxSize is
     * reached
     */
    ...
    /**
     * Checks if pattern is contained in source. This is just a wrapped KMP
     * indexOf().
     *
     * @param source
     * @param pattern
    ...
    /**
     * Get the last part of the array until a chosen char is found, the char is
     * searched from the end to the beginning of source.
     *
     * @param source
     * @param c
