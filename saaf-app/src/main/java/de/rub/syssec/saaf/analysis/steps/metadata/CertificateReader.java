...
public class CertificateReader {
    ...
    /**
     * This method calculates a SHA1 hash over the certificate, which equals
     * openssl's fingerprint option
     *
     * @return The SHA1 Fingerprint of this Certificate, which is identical to
     * openssl's "-fingerprint" option or null, in case it was not possible to
     ...
     *
     * @return the MD5 Fingerprint or null, in case it was not possible to
    ...
    /**
     *
     * @return the read X509Certificate or null, in case it was not possible to
     ...
     *
     * @return the fingerprint (SHA 1) or null, in case it was not possible to
     * generate a fingerprint
     * @throws IOException
     * @throws FileNotFoundException If the path to the apk is wrong/File does
     * not exist
     * @throws NoSuchAlgorithmException
     * @throws CertificateEncodingException
     */
