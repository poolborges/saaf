...
public class Application implements ApplicationInterface {
    ...
    /**
     * returns the calls which could be mapped to the permissions based on
     ...
     *
     * @param apk
     * @param warnIfDuplicate Show a info dialog if an app with the same hash is
     * already in the DB old param generateJava -> now set in
     * Config.GENERATE_JAVA If this is true java code is generated out of the
     * .class files
     * @throws Exception
     */
