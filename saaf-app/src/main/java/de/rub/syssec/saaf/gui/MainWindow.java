...
//				ActionEvent.ALT_MASK));
     ...
     * This has to be done for several operations which require a "target
     * application". If only one application is opened, this application is
     * returned w/o required user interaction.
     *
