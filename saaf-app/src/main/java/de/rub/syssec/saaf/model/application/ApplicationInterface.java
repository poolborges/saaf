...
public interface ApplicationInterface extends Entity {
     ...
     * @return the SmaliClass or null if the file is not part of this
     * application
     */
     ...
     *
     * @param component the component (Activity, Service, Receiver) that a class
     * should be found for.
     * @return the SmaliCalss implementing that component. null if none was
     * found.
     */
     ...
     * codelines of the adpackage should be included in the total number of
     * codelines
     ...
     * correct method
     *
     * TODO: If parameterDeclaration is null, the old behavior is triggered. But
     * this behavior is only a workaround and will be gone soon.
     *
     *
     * @param className the full package name of the class
     * @param methodName the name of the method
     * @param parameterDeclaration the unparsed parameters of the method
    ...
    /**
     * Get the message digest for the APK file. If the digest has not yet been
     * set, this method will return null but it will never throw an exception.
     *
     * Calculation should be done in the {@linkplain GenerateHashesStep} step
     * before any real operations start.
     *
