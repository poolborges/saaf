...
public class EntropyBasedDetectObfuscationStep extends AbstractStep {
     ...
     *
     * @see
     * <a href="http://en.wikipedia.org/wiki/Entropy_%28information_theory%29#Definition">
     * Definition</a>
     * @param name
     * @return
     */
     ...
     *
     * <ul>
     * <li>entropy1: calculated from concatenating the classname and all method
     * names </li>
     * <li>entropy2: calculated from concatenating class-,method- and fieldnames
     * </li>
     * <li>entropy3: calculated as the average over the entropies of class-,
     * method- and fieldnames</li>
     * </ul>
     *
     * @param smaliClass
     * @return
