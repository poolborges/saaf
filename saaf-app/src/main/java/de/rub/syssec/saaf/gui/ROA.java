...
public class ROA {
    ...
    /**
     * The delimiter for the property file. It will automatically be set to a
     * value which is not allowed in a filename.
     */
    ...
    /**
     * Return the actual list. The list itself is returned, so it can be
     * modified.
     *
     * @return the list
     */
