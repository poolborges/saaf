...
public class MySQLHPatternDAO implements NuHPatternDAO {
    ...
    private static final String QUERY_UPDATE = "UPDATE heuristic_pattern SET "
            + DB_COLUMN_PATTERN + "=?, "
            + DB_COLUMN_SEARCHIN + "=?, "
            + DB_COLUMN_HVALUE + "=?, "
            + DB_COLUMN_DESCR + "=?,"
            ...
            + DB_COLUMN_ID + "=?";
    private static final String QUERY_INSERT = "INSERT INTO heuristic_pattern("
            + DB_COLUMN_PATTERN + ","
            + DB_COLUMN_SEARCHIN + ","
            + DB_COLUMN_HVALUE + ","
            + DB_COLUMN_DESCR + ","
            + DB_COLUMN_ACTIVE + ")VALUES(?,?,?,?,?)";
    private static final String QUERY_READ = "SELECT * FROM heuristic_pattern WHERE "
            + DB_COLUMN_ID + "=?";
    ...
    private static final String DB_QUERY_FIND_EXISITING = "SELECT * FROM heuristic_pattern WHERE "
            + DB_COLUMN_PATTERN + "=? AND "
