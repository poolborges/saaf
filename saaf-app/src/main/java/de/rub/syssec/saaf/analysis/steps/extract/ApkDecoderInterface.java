...
public class ApkDecoderInterface {
    ...
    /**
     * What to do if the apktool installed on the users system is older than
     * ours.
     *
     ...
     * ~/apktool/framework/1.apk Handling:	3 Options for the user
     * ({@link Config}) - default:	APKTool only decode the smali files, no
     * Resources (incl. Manifest) - mv: rename the framework file, and complete
     * decode - del:	delete the framework file, and complete decode
     * </p>
     *
     * @param apk the apk
...
//		        public final static short DECODE_RESOURCES_FULL = 0x0101;
                ...
                /**
                 * Handle the special type of AndrolibException caused by an
                 * outdated version of Android-APKTool (used by SAAF) in
                 * contrast to the version the user uses.
                 */
