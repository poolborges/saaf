...
public interface MethodInterface extends Entity, Obfuscatable {
    ...
    /**
     * If the method contains unlinked Basic Blocks, this might indicate some
     * nop'ed out instructions. If all BBs are reachable, this method checks if
     * at least one BB contains unreachable code, eg, after a return statement.
