...
/**
 * This frame shows all methods for one smali class for which CFGs can be
...
public class CfgSelectorFrame extends JInternalFrame {
    ...
    /**
     * A frame to generate and open Control Flow Graphs. CFGs are created using
     * mxGraph and are saved as PNGs.
     *
    ...
    /**
     * Show a CFG in external viewer. CFG will be created on-the-fly if it does
     * not exists. This method will determine the selected method(s) from the
     * shown table.
     *
    ...
    /**
     * Copies the generated PNG to the specified directory. The directory must
