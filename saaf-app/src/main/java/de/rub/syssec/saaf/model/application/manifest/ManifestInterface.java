...
public interface ManifestInterface {
     ...
     *
     * This will only, be set if the original XML file for the manifest was
     * found to be non well-formed.
     *
     * @return the path to the cleaned XML file or null if original XML was
     * wel-formed.
     */
     ...
     *
     * This should only, be set if the original XML file for the manifest was
     * found to be non well-formed.
     *
     * @param file
     */
    ...
    /**
     *
     * @param activity the name of the activity (relative the the Manifests
     * package.
     *
     */
    ...
    /**
     * Convenience method to obtain all components (activites, services,
     * receivers).
     *
     * @return
     */
