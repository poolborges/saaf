...
public interface PackageInterface extends Entity {
    ...
    /**
     * This method returns the package name, split by either a file.separator or
     * a dot
     *
     * @param useDots this parameter detemines if the packagename is separated
     * by a "." or a File.Separator
     * @return the package name. example com.sun.package or com/sun/package
     */
    public abstract String getName(boolean useDots);

    /**
     * Sets the package name, deeper levels have to be separated by a "." .
     * example: com.sun.package
     *
